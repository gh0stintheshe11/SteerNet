...
def sync_video_and_steering_with_history(segment):
...
def process_all_segments(base_path=BASE_DIR):
    """
    ...
    for main_dir in tqdm(main_dirs, desc="Processing main directories"):
        ...
        for segment in segment_dirs:
            ...
            try:
                ...
                df = sync_video_and_steering_with_history(segment_path)
...
def process_all_segments_short(base_path=BASE_DIR):
    """
